...
trtexec --onnx=models/yolo11n.onnx --saveEngine=models/yolo11n-linux.engine  --tacticSources="+cublas,-cublasLt"
...
trtexec --onnx=models/yolo11n.onnx --saveEngine=models/yolo11n-win.engine  --tacticSources="+cublas,-cublasLt"
tensorrt_inference.exe ../../models/yolo11n-win.engine ../../assets/
```
